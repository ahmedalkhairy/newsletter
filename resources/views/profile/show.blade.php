                            ...
                            <div class="col-6">
                                ...
                                <ul class="ml-6 mb-2 fa-ul text-muted">
                                    <li class="big"><span class="fa-li"><i class="fa fa-user-circle"></i></span> Nom :
                                        {{ Auth::user()->name }}</li>
                                    <li class="big"><span class="fa-li"><i class="fa fa-user-circle"></i></span> Prenom:
                                        {{ Auth::user()->last_name }}</li>

                                    <li class="big"><span class="fa-li"><i class="fa fa-user"></i></span> Membre depuis
                                        : {{ Auth::user()->created_at->diffForHumans() }} </li>
                                    <li class="big"><span class="fa-li"><i class="far fa-envelope"></i></span> Addresse
                                        mail : {{ Auth::user()->email }}</li>
                                    <li class="big"><span class="fa-li"><i class="	fa fa-calendar"></i></span> Date de
                                        naissance : {{ Auth::user()->dob }} </li>

                                    <li class="big"><span class="fa-li"><i class="fa fa-edit"></i></span> Dernière
                                        modification : {{ Auth::user()->updated_at }} </li>
                                </ul>
                            </div>
                            <div class="col-6 text-center">


                                <img src="{{asset('storage/imgs/'.Auth::user()->photo)}} " alt=""
